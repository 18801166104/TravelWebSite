...
class Spots(models.Model):
    ...
    content = UEditorField(verbose_name='内容', width=600, height=300, imagePath="Scenic/ueditor/",
    ...
    classification = models.CharField(max_length=10, choices=(('natural', '景区'), ('leisure', '休闲')), default='natural',
                                      verbose_name='分类')
...
class Active(models.Model):
    ...
    introduce = UEditorField(verbose_name='活动介绍', width=600, height=300, imagePath="Active/ueditor/",
