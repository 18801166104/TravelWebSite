...
class NewsView(View):
    ...
    def get(self,request):
        ...
        return render(request,'news_list.html',{
            'all_news':all_news,
            'classification':news_type, 'culture': public_box.get('culture'), 'specialty': public_box.get('specialty'),
            'food': public_box.get('food'), 'life': public_box.get('life'), 'now_type': 'news',
        })
