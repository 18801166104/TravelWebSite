...
from pay.models import OrderItems, GoodsOrdersMainTable
from shop.models import Product, ProPic
...
class AllView(View):
    def get(self,request):
        ...
        return render(request, 'mall_list.html', {'all_pros': all_pros, 'pro_type': pro_type, 'now_type': 'shop',
            'culture': public_box.get('culture'), 'specialty': public_box.get('specialty'),
            'food': public_box.get('food'), 'life': public_box.get('life'), })
